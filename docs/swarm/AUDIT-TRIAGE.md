...
| Audit | Finding | Ledger | Verdict |
|---|---|---|---|
| **SRC-011** | Event and session creation is not transactional | **NEW → T330** | Real but proportionate to a volunteer team of ~20 (constitution item 25). Same family as SRC-009. |
