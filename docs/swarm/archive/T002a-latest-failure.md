...
---
**ARCHIVED 2026-07-16.** Resolved on attempt 2 (glob negation fix). T002a Passed checker-tests. See `docs/swarm/verification-log.md` (T002a entry) and `docs/swarm/task-ledger.md` (T002a row).
