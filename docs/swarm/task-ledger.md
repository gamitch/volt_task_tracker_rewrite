...
| T035 | E5 | `/checkin` result screen + Check-in Bolt | worker-implementer | checker-accessibility | T032 | 0 | In Progress | Worker done (`58d5a06`), flags missing running-tally data source (DES-01 vs checkin contract) as dispute candidate; added test file outside literal Allowed Files (disclosed). Checker dispatched per `docs/swarm/active/T035-checker-packet.md`. | No |
