...
| T019 | E3 | DB trigger: invite acceptance → profile/link | worker-implementer | checker-reviewer | T017,T009 | 0 | Ready | Unblocked 2026-07-18 on T017's PASS full-ledger sweep (T017 and T009 both now Passed). Worker packet drafted at `docs/swarm/active/T019-worker-packet.md`. Not yet dispatched. | No |
