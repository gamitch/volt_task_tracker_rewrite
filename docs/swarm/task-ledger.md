...
| T018 | E3 | `/accept-invite` screen | worker-implementer | checker-accessibility | T016,T017 | 0 | Ready | Unblocked 2026-07-18 on T017's PASS full-ledger sweep (T016 and T017 both now Passed). Not yet dispatched. | No |
| T019 | E3 | DB trigger: invite acceptance → profile/link | worker-implementer | checker-reviewer | T017,T009 | 0 | Ready | Unblocked 2026-07-18 on T017's PASS full-ledger sweep (T017 and T009 both now Passed). Not yet dispatched. | No |
...
| T032 | E5 | `checkin` Edge Function (HMAC rotating token) | worker-implementer | checker-tests | T010,T012 | 0 | In Progress | Dispatched 2026-07-18 as part of a 4-task parallel batch (T014/T017/T032/T061, file-disjoint). Worker packet: `docs/swarm/active/T032-worker-packet.md`. External blocker flagged: no live Supabase project exists yet (George's prerequisite), so this attempt is scoped to structurally correct, secret-free code plus local/unit-level HMAC and grace-window logic tests, not live end-to-end verification. | No |
...
| T048 | E8 | Resend integration + branded layout + `email_log` | worker-implementer | checker-reviewer | T017 | 0 | Ready | Unblocked 2026-07-18 on T017's PASS full-ledger sweep (sole dependency T017 now Passed). Not yet dispatched. | No |
...
| T056 | E9 | `/reports` shell + Participation tab | worker-implementer | checker-accessibility | T013,T014 | 0 | Ready | Unblocked 2026-07-18 on T014's PASS full-ledger sweep (T013 and T014 both now Passed). Not yet dispatched. | No |
...
| T061 | E10 | Schema verification + mapping doc copy (MIG-01/02) | worker-implementer | checker-reviewer | T009,T010,T011 | 0 | In Progress | Dispatched 2026-07-18 as part of a 4-task parallel batch (T014/T017/T032/T061, file-disjoint). Worker packet: `docs/swarm/active/T061-worker-packet.md`. Foreman pre-check found no live old-project connection info (OLD_SUPABASE_URL/OLD_SERVICE_ROLE_KEY) anywhere in the repo — this is an unmet external prerequisite in the same category as the Supabase-project-creation blocker; MIG-01 is scoped to confirming/documenting this blocker rather than fabricating a live diff, while MIG-02 (mapping.md verbatim copy) is fully achievable now. | No |
