...
| T034 | E5 | Kiosk view `/kiosk/:sessionId` | worker-implementer | checker-accessibility | T032 | 0 | Ready | Unblocked 2026-07-19 on T032's PASS full-ledger sweep (sole dependency T032 now Passed). Not yet dispatched. | No |
| T035 | E5 | `/checkin` result screen + Check-in Bolt | worker-implementer | checker-accessibility | T032 | 0 | Ready | Unblocked 2026-07-19 on T032's PASS full-ledger sweep (sole dependency T032 now Passed). Not yet dispatched. | No |
