...
| T004 | E1 | CI pipeline (typecheck/lint/unit/build + bundle budget) | worker-implementer | checker-tests | T001,T002,T003 | 0 | In Progress | Dispatched 2026-07-17 — worker packet at `docs/swarm/active/T004-worker-packet.md`. | No |
...
| T012 | E2 | RLS helper functions + policies (verbatim 8.4) | worker-implementer | checker-tests | T009,T010,T011 | 0 | Ready | Unblocked 2026-07-17 on T011's PASS full-ledger sweep (T009, T010, T011 all now Passed). Not yet dispatched. | No |
