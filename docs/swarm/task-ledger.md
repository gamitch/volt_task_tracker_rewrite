...
| T002b | E1 | Dark-mode `--color-on-accent` contrast fix (D005 corrective task) | worker-implementer | checker-accessibility | T002,T003 | 0 | In Progress | Worker packet dispatched at `docs/swarm/active/T002b-worker-packet.md` (George approved dispatch 2026-07-19). Awaiting worker attempt 1. | No |
