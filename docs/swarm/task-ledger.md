...
| T012 | E2 | RLS helper functions + policies (verbatim 8.4) | worker-implementer | checker-tests | T009,T010,T011 | 0 | In Progress | Worker packet built and dispatched 2026-07-17 (`docs/swarm/active/T012-worker-packet.md`). Attempt 1 in flight. | No |
