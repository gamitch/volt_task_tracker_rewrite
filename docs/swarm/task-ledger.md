...
| T020 | E3 | AUTH-04 uninvited path + RLS-denial test | worker-implementer | checker-tests | T012,T018,T019 | 0 | In Progress | Worker packet dispatched at `docs/swarm/active/T020-worker-packet.md`. Awaiting worker attempt 1. | No |
