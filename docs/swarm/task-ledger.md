...
| T034 | E5 | Kiosk view `/kiosk/:sessionId` | worker-implementer | checker-accessibility | T032 | 0 | In Progress | Dispatched 2026-07-19 to worker-implementer per `docs/swarm/active/T034-worker-packet.md`. Awaiting worker output. | No |
...
| T048 | E8 | Resend integration + branded layout + `email_log` | worker-implementer | checker-reviewer | T017 | 0 | In Progress | Dispatched 2026-07-19 to worker-implementer per `docs/swarm/active/T048-worker-packet.md`. Awaiting worker output. | No |
