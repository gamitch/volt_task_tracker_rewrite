...
| T003 | E1 | CSS cascade layers + `theme.css` build pattern | worker-implementer | checker-tests | T002,T002a | 0 | In Progress | Worker packet dispatched 2026-07-17 (parallel dispatch with T005, T010). | No |
...
| T005 | E1 | Router skeleton + route guards + deep-link redirect | worker-implementer | checker-reviewer | T001 | 0 | In Progress | Worker packet dispatched 2026-07-17 (parallel dispatch with T003, T010). | No |
