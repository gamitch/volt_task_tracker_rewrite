...
| T014 | E2 | NFR-03 metric-view fixture tests | worker-implementer | checker-tests | T013 | 0 | In Progress | Dispatched 2026-07-18 as part of a 4-task parallel batch (T014/T017/T032/T061, file-disjoint). Worker packet: `docs/swarm/active/T014-worker-packet.md`. | No |
...
| T017 | E3 | `send-invite` Edge Function | worker-implementer | checker-reviewer | T009,T012 | 0 | In Progress | Dispatched 2026-07-18 as part of a 4-task parallel batch (T014/T017/T032/T061, file-disjoint). Worker packet: `docs/swarm/active/T017-worker-packet.md`. External blocker flagged: no live Supabase project exists yet (George's prerequisite), so this attempt is scoped to structurally correct, secret-free code, not live end-to-end verification. | No |
