...
| T003 | E1 | CSS cascade layers + `theme.css` build pattern | worker-implementer | checker-tests | T002,T002a | 0 | Ready | Unblocked: T002a Passed 2026-07-16 (both deps T002, T002a now Passed). | No |
