...
| T021 | E4 | `/roster` shell + TabList | worker-implementer | checker-accessibility | T007,T019 | 0 | In Progress | Worker packet dispatched at `docs/swarm/active/T021-worker-packet.md`. Awaiting worker attempt 1. | No |
