...
| T062 | E10 | ETL script `scripts/migrate.ts` (MIG-03) | worker-implementer | checker-tests | T061 | 0 | Ready | Unblocked 2026-07-18 on T061's PASS full-ledger sweep (sole dependency T061 now Passed). Not yet dispatched. | No |
