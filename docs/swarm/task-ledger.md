...
| T035 | E5 | `/checkin` result screen + Check-in Bolt | worker-implementer | checker-accessibility | T032 | 0 | In Progress | Dispatched 2026-07-19 to worker-implementer per `docs/swarm/active/T035-worker-packet.md`. Awaiting worker output. | No |
