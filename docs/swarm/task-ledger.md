...
| T020 | E3 | AUTH-04 uninvited path + RLS-denial test | worker-implementer | checker-tests | T012,T018,T019 | 0 | Ready | Unblocked 2026-07-19 on T018's PASS full-ledger sweep (T012, T018, T019 all now Passed) — closes out E3. Not yet dispatched, no worker packet drafted yet. | No |
