...
// doc #5/#6 gap) -- 'staff' stands in for "not coach/admin" here, which is
// exactly the branch MeetingsList's own `isCoachOrAdminView` check falls
// through on for any non-coach/admin role.
