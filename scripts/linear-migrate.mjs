...
const LABEL_SPECS = [
  ...
  ['provenance', 'Who or what found this. A triager needs to know how much to trust the premise.'],
  ['provenance/e2e-personas', 'Found by the persona end-to-end harness against a real database.'],
  ['provenance/owner-live-testing', 'Found by the owner using the running app.'],
  ['provenance/premise-gate', 'Found by checker-premise before dispatch.'],
  ['provenance/checker', 'Found by a checker during review.'],
  ['provenance/audit', 'Found by an audit pass. Treat the premise as unverified — five such rows measured false.'],
  ['provenance/other', 'Found some other way; say how in the description.'],
